...
@Component({
  selector: 'app-shop-category-flower',
  templateUrl: './shop-category-flower.page.html',
  styleUrls: ['./shop-category-flower.page.scss'],
})
export class ShopCategoryFlowerPage implements OnInit {
