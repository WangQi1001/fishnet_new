...
@Component({
  selector: 'app-shop-category-bird',
  templateUrl: './shop-category-bird.page.html',
  styleUrls: ['./shop-category-bird.page.scss'],
})
export class ShopCategoryBirdPage implements OnInit {
