...
@Component({
  selector: 'app-shop-category-fish',
  templateUrl: './shop-category-fish.page.html',
  styleUrls: ['./shop-category-fish.page.scss'],
})
export class ShopCategoryFishPage implements OnInit {
